...
const AlbumPreview = ({album}) => {
  ...
  return (
    <>
     <h2 className="text-3xl font-bold">Prévisualisation de l'album</h2>
       <h4 className="text-xl font-semibold mb-2">Pistes</h4>
      <DataTable data={album.audioData} columns={tracksColumns} />
    </>
  );
};
